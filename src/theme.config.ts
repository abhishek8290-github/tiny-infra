...
const theme = {
  ...
  presets: {
    ...
    ocean: {
      label: "Ocean",
      description: "Cool, deep blue, calm modern tech",
      fonts: {
        display: "'Syne', sans-serif",
        body: "'Mulish', sans-serif",
        mono: "'Fira Code', monospace",
        displayUrl: "https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=Mulish:wght@300;400;500;600&family=Fira+Code:wght@400;500&display=swap",
        bodyUrl: "",
      },
      radius: "0.75rem",
      ...
      tokens: {
        light: {
          background: "210 55% 98%", foreground: "215 50% 14%",
          card: "0 0% 100%", "card-foreground": "215 50% 14%",
          popover: "0 0% 100%", "popover-foreground": "215 50% 14%",
          primary: "204 90% 42%", "primary-foreground": "0 0% 100%",
          secondary: "204 70% 93%", "secondary-foreground": "215 50% 14%",
          muted: "210 35% 93%", "muted-foreground": "215 18% 42%",
          accent: "199 85% 88%", "accent-foreground": "215 50% 14%",
          destructive: "0 72% 50%", "destructive-foreground": "0 0% 100%",
          border: "209 35% 85%", input: "209 35% 85%", ring: "204 90% 42%",
          sidebar: "208 65% 97%", "sidebar-foreground": "215 50% 14%",
          "sidebar-border": "209 35% 85%", "sidebar-accent": "201 75% 90%",
          "sidebar-accent-foreground": "215 50% 14%", "sidebar-primary": "204 90% 42%",
          "sidebar-primary-foreground": "0 0% 100%", "sidebar-ring": "204 90% 42%",
        },
        dark: {
          background: "217 48% 8%", foreground: "210 40% 96%",
          card: "216 42% 12%", "card-foreground": "210 40% 96%",
          popover: "216 42% 12%", "popover-foreground": "210 40% 96%",
          primary: "199 90% 58%", "primary-foreground": "217 48% 8%",
          secondary: "214 34% 16%", "secondary-foreground": "210 40% 96%",
          muted: "214 34% 16%", "muted-foreground": "213 20% 62%",
          accent: "208 38% 22%", "accent-foreground": "210 40% 96%",
          destructive: "0 68% 50%", "destructive-foreground": "0 0% 100%",
          border: "213 32% 21%", input: "213 32% 21%", ring: "199 90% 58%",
          sidebar: "217 48% 7%", "sidebar-foreground": "210 40% 96%",
          "sidebar-border": "213 32% 18%", "sidebar-accent": "214 34% 14%",
          "sidebar-accent-foreground": "210 40% 96%", "sidebar-primary": "199 90% 58%",
          "sidebar-primary-foreground": "217 48% 8%", "sidebar-ring": "199 90% 58%",
        },
      },
    } satisfies ThemePreset,
